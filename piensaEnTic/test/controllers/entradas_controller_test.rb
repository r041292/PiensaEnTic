...
class EntradasControllerTest < ActionController::TestCase
  ...
  test "should create entrada" do
    assert_difference('Entrada.count') do
      post :create, entrada: { ciudad: @entrada.ciudad, colegio: @entrada.colegio, email: @entrada.email, link_bloopers: @entrada.link_bloopers, link_video: @entrada.link_video, nivel: @entrada.nivel, nombre: @entrada.nombre }
    end
  ...
  test "should update entrada" do
    patch :update, id: @entrada, entrada: { ciudad: @entrada.ciudad, colegio: @entrada.colegio, email: @entrada.email, link_bloopers: @entrada.link_bloopers, link_video: @entrada.link_video, nivel: @entrada.nivel, nombre: @entrada.nombre }
    assert_redirected_to entrada_path(assigns(:entrada))
  end
